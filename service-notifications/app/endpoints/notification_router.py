...
async def send_new_response_notification(
    ...
    """
    return await service.send_new_response_notification(recipient_id, responder_name)
...
async def send_response_rejected_notification(
    recipient_id: int,
    service: NotificationService = Depends()
):
    """
    ...
    - **recipient_id**: ID получателя уведомления
    """
    return await service.send_response_rejected_notification(recipient_id)
...
async def send_response_accepted_notification(
    recipient_id: int,
    service: NotificationService = Depends()
):
    """
    ...
    - **recipient_id**: ID получателя уведомления
    """
    return await service.send_response_accepted_notification(recipient_id)
...
async def send_task_completed_notification(
    ...
    """
    return await service.send_task_completed_notification(recipient_id, task_title)
...
async def send_rating_changed_notification(
    recipient_id: int,
    new_rating: float,
    service: NotificationService = Depends()
):
    ...
    """
    return await service.send_rating_changed_notification(recipient_id, new_rating)
